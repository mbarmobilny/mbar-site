...
export const translations = {
  pl: {
    ...
    basedIn: "Siedziba",
    since: "Od roku",
    photoCaption: "Yan Maihur — Główny barman mBar",
    ...
    area: "Obszar",
    response: "Odpowiedź",
    serviceArea: "Promień 80 km od centrum",
  ...
  en: {
    ...
    basedIn: "Based in",
    since: "Since",
    photoCaption: "Yan Maihur — Head Bartender, mBar",
    ...
    area: "Area",
    response: "Response",
    serviceArea: "50-mile radius from downtown",
